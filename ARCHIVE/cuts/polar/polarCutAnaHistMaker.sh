...
echo root -b -q azCutsAnaHistMaker.C\+\(\"$runListInputFile\"\,\"$outputRootHistogramFile\",$nEvents,$azMin,$azMax\) >> $logFile &
root -b -q azCutsAnaHistMaker.C\+\(\"$runListInputFile\"\,\"$outputRootHistogramFile\",$nEvents,$azMin,$azMax\) >> $logFile &
