...
void nDigitDependence1stPreamp() {

TFile* cftFile = new TFile("/Users/jeremy/niffte/trees/cfCFT.1stPreamp.trees.1865.73.83.root");
TFile* noMaskFile = new TFile("/Users/jeremy/niffte/trees/cfNoMask.1stPreamp.trees.1850-56.66-72.74-82.root");
// TFile* cftFile = new TFile("/Users/jeremy/niffte/trees/hkReco.cfCFT.1stPreamp.trees.1865.73.83.root");
// TFile* noMaskFile = new TFile("/Users/jeremy/niffte/trees/hkReco.cfNoMask.1stPreamp.trees.1850-56.66-72.74-82.root");
...
for (int nDig = startDigStep; nDig <= lastDigStep; nDig+=digStepSize){
	...
	nDigCut.str("");
    nDigCut<< 0 << " < nDigits && nDigits < "<< maxDig <<" && fitType==10 && trackNo==1";
	...
	// sprintf(pngname,"frags.full.cft.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	...
	// sprintf(pngname,"frags.full.noMask.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	// c1->SaveAs(pngname,"recreate");
	...
	// legend1->Draw("same");
	// sprintf(pngname,"bothFragsCut.withFits.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	// c1->SaveAs(pngname,"recreate");
	// c1->SetLogx(0);
	...
	// cftFragsRebin->Draw("same");
	// legend1->Draw("same");
	// sprintf(pngname,"lowEn.plusCFT.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	// c1->SaveAs(pngname,"recreate");
	...
	// cftEfficiency->Draw();
	// sprintf(pngname,"cftEfficiency.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	// c1->SaveAs(pngname,"recreate");
	...
	// sprintf(pngname,"cftEfficiencyWithFrags.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	// c1->SaveAs(pngname,"recreate");
	...
	// cftEfficiency->SetLineColor(6);
	// cftEfficiency->Draw();
	// sprintf(pngname,"cftEfficiency.log.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	// c1->SaveAs(pngname,"recreate");
	// noMaskFragsRebin->SetMinimum(0.001);
	// noMaskFragsRebin->Draw();
	// cftFragsRebin->Draw("same");
	// cftEfficiency->Draw("same");
	// legendCFTefficiency->Draw("same");
	// sprintf(pngname,"cftEfficiencyWithFrags.log.2ndPreamp.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	// c1->SaveAs(pngname,"recreate");
	...
	cftLvEn->Draw("colz");
	sprintf(pngname,"cftLvEn.full.log.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
	cftLvEn->GetYaxis()->SetRangeUser(0,2);
	sprintf(pngname,"cftLvEn.full.log.zoom.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
	...
	cftLvEn->Draw("Colz");
	fragCut->Draw("same");
	sprintf(pngname,"cftLvEn.full.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
	...
	cftLvEn->Draw("Colz");
	fragCut->Draw("same");
	sprintf(pngname,"cftLvEn.lowEn.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
	...
	sprintf(pngname,"noMaskLvEn.full.log.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
	noMaskLvEn->GetYaxis()->SetRangeUser(0,2);
	sprintf(pngname,"noMaskLvEn.full.log.zoom.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
	...
	noMaskLvEn->Draw("Colz");
	// fragCut->Draw("same");
	sprintf(pngname,"noMaskLvEn.full.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
	...
	noMaskLvEn->Draw("Colz");
	fragCut->Draw("same");
	sprintf(pngname,"noMaskLvEn.lowEn.minDig%0.3d.maxDig%0.3d.png",minDig,maxDig);
	c1->SaveAs(pngname,"recreate");
