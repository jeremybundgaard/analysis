...
tracks_ghostTail_Flag->Draw("length:adc>>LvsADC","!is_ghostTail&&!(-1<direction.Phi()&&direction.Phi()<0)","colz");
ellipse_canvas->SaveAs("tracks_ghostTail_Flag_LvsADC.is_ghostTail_not.png");

tracks_ghostTail_Flag->Draw("length:adc>>LvsADC","is_ghostTail||has_ghostTail","colz");
ellipse_canvas->SaveAs("tracks_ghostTail_Flag_LvsADC.is_ghostTail||has_ghostTail.png");

tracks_ghostTail_Flag->Draw("length:adc>>LvsADC","has_ghostTail","colz");
ellipse_canvas->SaveAs("tracks_ghostTail_Flag_LvsADC.has_ghostTail.png");

tracks_corrected->Draw("length:adc>>LvsADC","!(-1<direction.Phi()&&direction.Phi()<0)","colz");
ellipse_canvas->SaveAs("tracks_corrected_LvsADC.png");
