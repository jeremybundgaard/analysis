...
void buildAlphaRidgeCutSuppGoodFP() {

TFile* noMaskFile = new TFile("$trees/fp.suppGood.trees.root");
...
noMaskTracks->Draw("length:adc*168.6/40000>>noMaskLvEn","bestFit","colz");
Double_t xCut[29];
Double_t yCut[29];
char projname[123];
int xBuffer = 150;
...
TF1 *f = new TF1("f", "[3] + [2]*TMath::Exp( [1]*x + [0] )",1,xCut[29 - 1]);
f->SetLineWidth(3);
f->SetLineColor(kRed);
g->Fit(f);
noMaskLvEn->SetTitle(f->GetTitle());
noMaskLvEn->Draw("Colz");
f->DrawF1(1,xCut[29 - 1],"same");
...
// double_t alphaRidgeFitStartX = f->GetX(alphaRidgeFitStartY);
// double_t alphaRidgeFitStopY = 1.1;
// double_t alphaRidgeFitStopX = f->GetX(alphaRidgeFitStopY);
...
fragCutSimple->SetPoint(1, 15,1.50+0.4);
fragCutSimple->SetPoint(2, 35,1.95+0.4);
fragCutSimple->SetPoint(3, 71,2.75+0.4);
fragCutSimple->SetPoint(4, 150,3.25+0.4);
fragCutSimple->SetPoint(5, 150,1.25+0.4);
fragCutSimple->SetPoint(6, 1.5,0+   0.4);
fragCutSimple->SetPoint(7, 2.5,0.70+0.4);
fragCutSimple->SetPoint(0, 2.5,0.70+0.4);
// fragCutSimple->SetPoint(6, alphaRidgeFitStartX,alphaRidgeFitStartY);
...
// 	newCutPoint++;
// 	noMaskLvEn->Draw("Colz");
// 	f->DrawF1(alphaRidgeFitStartX-.2,alphaRidgeFitStopX+.2,"same");
