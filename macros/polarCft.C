...
void polarCft(const int preamp, const char* actinide, const char* noMaskFileName="", const char* cftFileName="", const char* otherTreeCuts="1",const char* pidType="") {
...
// noMask_CosTheta_short_higher->SetLineWidth((Width_t)0.01+7);
...
// cft_CosTheta_short_higher->SetLineWidth((Width_t)0.01+7);
