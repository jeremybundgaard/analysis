...
TH1D *radVsIntensity = new TH1D("radVsIntensity","radVsIntensity",1000,0,5);
...
TH1D *averageIntensityVsRadius = new TH1D("averageIntensityVsRadius","averageIntensityVsRadius",radBinMap.size(),0,radBinMap.size());
