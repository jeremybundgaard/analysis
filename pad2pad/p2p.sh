...
mkdir evtLengthBinScalePlots
mkdir padIndexScaleHistPlots
mkdir padIndexScaleHistPlots/log
mkdir padIndexScaleHistPlots/linear

mv lengthBinScalesPerEvt_evt*png evtLengthBinScalePlots/.
mv log.padIndex_*png padIndexScaleHistPlots/log/.
mv padIndex*png padIndexScaleHistPlots/linear/.
