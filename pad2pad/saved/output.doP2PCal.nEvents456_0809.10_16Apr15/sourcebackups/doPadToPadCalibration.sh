...
echo "export DB_FAIL_OK=1; niffte -c /g/g21/jerbundg/niffte/trunk/build/TPCBuildAverageBraggCurve.xml -i /p/lscratche/jerbundg/data/thesisData/raw/cm/noMask/1stPreamp/niffte-run100001922_20Jun2013_11-04.raw -n $nEvents" >> $logfile

echo "start building average bragg curves:   `date +%H%M.%S_%d%b%y` "
export DB_FAIL_OK=1; niffte -c /g/g21/jerbundg/niffte/trunk/build/TPCBuildAverageBraggCurve.xml -i /p/lscratche/jerbundg/data/thesisData/raw/cm/noMask/1stPreamp/niffte-run100001922_20Jun2013_11-04.raw -n $nEvents >> $logfile
...
echo "export DB_FAIL_OK=1; niffte -c /g/g21/jerbundg/niffte/trunk/build/TPCPadToPadCalibration.xml -i /p/lscratche/jerbundg/data/thesisData/raw/cm/noMask/1stPreamp/niffte-run100001922_20Jun2013_11-04.raw -n $nEvents" >> $logfile

echo "start computing scale factors:   `date +%H%M.%S_%d%b%y` "
export DB_FAIL_OK=1; niffte -c /g/g21/jerbundg/niffte/trunk/build/TPCPadToPadCalibration.xml -i /p/lscratche/jerbundg/data/thesisData/raw/cm/noMask/1stPreamp/niffte-run100001922_20Jun2013_11-04.raw -n $nEvents >> $logfile
